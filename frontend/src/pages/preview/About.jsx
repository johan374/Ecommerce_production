...
// Replace the import with direct path reference
const profileImage = '/assets/yo.jpg'; // Assuming the image is in public/assets/
      ...
      <div className="relative max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <img
            src={profileImage}
            alt="Profile picture"
            className="w-32 h-32 rounded-full mx-auto mb-6 border-2 border-white"
          />
